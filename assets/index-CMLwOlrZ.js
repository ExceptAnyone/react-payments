...
const buttonSize = {
  large: (theme2) => css`
    ...
    background-color: ${theme2.color.cardBlack};

    ${theme2.font.button.text2}
  `
};
const Button = (props) => {
  const { children, variant, ...rest } = props;
  return /* @__PURE__ */ jsx$1("button", { css: [buttonStyle, buttonSize[variant]], ...rest, children });
};
const sectionTitle = css`
  ...
  gap: 0.4rem;
`;
const sectionTitleText = css`
  color: ${theme.color.black};
  ${theme.font.cardNumberInput.title}
`;
const sectionTitleSubText = css`
...
function Title({ children }) {
  return /* @__PURE__ */ jsx$1("div", { css: sectionTitle, children });
}
function Text({ children }) {
  return /* @__PURE__ */ jsx$1("span", { css: sectionTitleText, children });
}
function SubTitle({ children }) {
  return /* @__PURE__ */ jsx$1("span", { css: sectionTitleSubText, children });
}
Title.Text = Text;
...
`;
const cardDetailContainer = css`
  display: flex;
  flex-direction: row;
  gap: 0.5rem;
`;
const cardDetailText = css`
...
const useFunnel = (props) => {
  ...
  const [step, setStep] = reactExports.useState(defaultStep);
  const FunnelComponent = reactExports.useMemo(() => {
    const FunnelWithSteps = (props2) => /* @__PURE__ */ jsx$1(Funnel, { step, steps, ...props2 });
    FunnelWithSteps.Step = Step;
    return FunnelWithSteps;
  }, [step, steps]);
  return { Funnel: FunnelComponent, step, setStep };
};
const inputContainer$1 = css`
  display: flex;
  height: 3.2rem;
  padding: 0.8rem;
  align-items: center;
...
const inputSection = css`
  ...
  gap: 0.8rem;
`;
const isOnlyDigits = (value) => DIGITS_ONLY_REGEX.test(value);
const useCardField = (validationConfig) => {
  ...
  const handleChange = (inputValue) => {
    ...
    if (isNumber) {
      if (inputValue.length > 0) {
        ...
        if (validationConfig.minValue !== void 0 && numValue < validationConfig.minValue || validationConfig.maxValue !== void 0 && numValue > validationConfig.maxValue) {
          setError(true);
          setValue(inputValue);
          return;
        }
  ...
  const isValid = () => {
    ...
    const isLengthValid = validationConfig.requiredLength === void 0 || value.length === validationConfig.requiredLength;
    const isMinValid = validationConfig.minValue === void 0 || numValue >= validationConfig.minValue;
    const isMaxValid = validationConfig.maxValue === void 0 || numValue <= validationConfig.maxValue;
  ...
  const getErrorMessage = () => {
    ...
    if (validationConfig.errorMessages.invalidValue && (validationConfig.minValue !== void 0 && numValue < validationConfig.minValue || validationConfig.maxValue !== void 0 && numValue > validationConfig.maxValue)) {
...
const createCardNumberError = (fields) => {
...
const useCardNumber = () => {
  ...
  const handleCardNumberChange = (e) => {
    ...
    if (name in fields) {
      fields[name].handleChange(value);
    }
  };
  ...
  const isCardNumberValid = () => {
    return CARD_NUMBER_FIELD_NAMES.every((name) => {
      return fields[name].isValid() && fields[name].value.length === CARD_NUMBER.maxLength;
    });
  };
...
const useCardCVC = () => {
  ...
  const cardCVC = cvcValue ? Number(cvcValue) : null;
...
const CardProvider = ({ children }) => {
  ...
  const [selectedCardBrand, setSelectedCardBrand] = reactExports.useState(
    null
  );
  const cardBrandColor = selectedCardBrand ? theme.color[cardBrandNames[selectedCardBrand]] || theme.color.cardBlack : theme.color.cardBlack;
  const value = {
    cardNumber,
    cardNumberError,
    handleCardNumberChange,
  ...
  return /* @__PURE__ */ jsx$1(CardContext.Provider, { value, children });
};
const useCard = () => {
...
function CardNumberInput(props) {
  ...
  const hasError = errorState.first || errorState.second || errorState.third || errorState.forth;
  ...
  return /* @__PURE__ */ jsxs("div", { css: cardNumberInputLayout, children: [
    ...
    /* @__PURE__ */ jsx$1(Input.Group, { id: "card-number", children: /* @__PURE__ */ jsxs("div", { css: inputContainer, children: [
      ...
      hasError && /* @__PURE__ */ jsx$1("div", { css: errorMessageStyle, children: getCardNumberErrorMessage() })
    ] }) })
  ] });
}
...
const Dropdown = ({
  ...
  return /* @__PURE__ */ jsxs("div", { css: dropdownContainer, children: [
    /* @__PURE__ */ jsxs(
      "select",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx$1("option", { value: "", disabled: true, children: placeholder }),
          children
        ]
      }
    ),
    /* @__PURE__ */ jsx$1("div", { css: dropdownArrow, children: /* @__PURE__ */ jsx$1(
      "svg",
      {
        width: "24",
        height: "24",
...
const DropdownOption = ({ value, children, ...props }) => {
...
function CardPeriodInput(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { css: cardPeriodInputLayout, children: [
    ...
    /* @__PURE__ */ jsx$1(Input.Group, { id: "card-expiration", children: /* @__PURE__ */ jsxs("div", { css: inputContainer, children: [
      ...
      errorState.month && /* @__PURE__ */ jsx$1("div", { css: errorMessageStyle, children: getMonthErrorMessage() }),
      errorState.year && !errorState.month && /* @__PURE__ */ jsx$1("div", { css: errorMessageStyle, children: getYearErrorMessage() })
    ] }) })
  ] });
}
    ...
    /* @__PURE__ */ jsx$1(Input.Group, { id: "card-cvc", children: /* @__PURE__ */ jsxs("div", { css: inputContainer, children: [
      ...
      /* @__PURE__ */ jsx$1("article", { css: inputSection, children: /* @__PURE__ */ jsx$1(
        Input,
        {
          ...
          css: hasError ? errorInputStyle : void 0
        }
      ) }),
      hasError && /* @__PURE__ */ jsx$1("div", { css: errorMessageStyle, children: getCardCVCErrorMessage() })
    ] }) })
  ] });
}
...
const cardContent = css`
  ...
  gap: 10px;
`;
const cardContentText = css`
  color: ${theme.color.white};
  ${theme.font.card.number}
`;
const dynamicCardStyle = (cardBrandColor) => css`
  ${cardLayout}
...
function CardPasswordInput() {
  ...
  const handlePaymentComplete = reactExports.useCallback(() => {
    var _a;
    const cardNumberFirst = (_a = cardNumber.first) == null ? void 0 : _a.toString();
  ...
  return /* @__PURE__ */ jsxs("div", { css: cardPasswordInputLayout, children: [
    ...
    /* @__PURE__ */ jsx$1(Input.Group, { id: "card-password", children: /* @__PURE__ */ jsxs("div", { css: inputContainer, children: [
      /* @__PURE__ */ jsx$1(Input.Label, { children: "비밀번호" }),
      /* @__PURE__ */ jsx$1("article", { css: inputSection, children: /* @__PURE__ */ jsx$1(
        Input,
        {
          type: "password",
      ...
      hasError && /* @__PURE__ */ jsx$1("div", { css: errorMessageStyle, children: getCardPasswordErrorMessage() })
    ] }) }),
    isCompleteForm && /* @__PURE__ */ jsx$1(
      Button,
      {
        variant: "large",
      ...
      /* @__PURE__ */ jsxs(Funnel2.Step, { name: STEPS[1], children: [
        ...
        /* @__PURE__ */ jsxs(
          Dropdown,
          {
            ...
            children: [
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "bc", children: "BC카드" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "shinhan", children: "신한카드" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "kakao", children: "카카오뱅크" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "hyundai", children: "현대카드" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "woori", children: "우리카드" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "lotte", children: "롯데카드" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "hana", children: "하나카드" }),
              /* @__PURE__ */ jsx$1(Dropdown.Option, { value: "kb", children: "국민카드" })
            ]
          }
        )
      ] }),
...
const router = createBrowserRouter([
  {
    path: "/",
    element: /* @__PURE__ */ jsx$1(CardProvider, { children: /* @__PURE__ */ jsx$1(CardPaymentPage, {}) })
  },
  {
    path: "/complete",
    element: /* @__PURE__ */ jsx$1(CardFormComplete, {})
  }
]);
function App() {
